...
public class WmsServletRequestProcessor {
    ...
    public WmsServletRequestProcessor(WmsGetCapabilitiesProvider getCapabilitiesProvider, Layers layers,
    ...
    private void writeImage(BufferedImage image, ByteArrayOutputStream os, String imageType) throws IOException {
