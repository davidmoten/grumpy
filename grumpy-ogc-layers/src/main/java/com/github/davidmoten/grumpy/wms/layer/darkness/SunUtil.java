...
public final class SunUtil {
     ...
     * 
     */
    public static Twilight getUniformTwilight(Bounds region, Position subSolarPoint) {
    ...
    public static Position getSubSolarPoint() {
        return getSubSolarPoint(GregorianCalendar.getInstance(TimeZone.getTimeZone("GMT")));
    }
